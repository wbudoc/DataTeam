...
FROM z_newcreate_all_account_report_20200115 zn 
LEFT JOIN z_newcreate_exist_address_20200115 a ON zn.userId=a.userId
...
LEFT JOIN z_newcreate_exist_address_20200115 a ON cc.addressId=a.id
LEFT JOIN address_type t ON a.addressType=t.id
LEFT JOIN country c ON a.countryId=c.id
